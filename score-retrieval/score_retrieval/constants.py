...
#ORIGINAL_ORG = TRUE
#change single database
#multi-database = false

random.seed(0)

# base data constants
DATA_DIR = "/data1/dyang/Projects/Evan_CNNRetrieval/score_retrieval/data"
...
gpu = True
DEFAULT_DATASET = "queries_all"
#DEFAULT_DATASET = "ref_jpgs"
#JUST LEAVE FALSE
QUERY_TOGGLE = False
TRAIN_QUERIES = True
...
QUERY_DATASET = "queries_all"
#QUERY_DATASET = "Queries_Spoc"
#DB_DATASET = "Chopin"
DB_DATASET = "CNN_Features_Spoc"
AUGMENT_DB_DATASET = "piano_dataset_test"
TRAIN_DATASET = "piano_dataset_test"
AUGMENT_DB_TO = 50
MULTIDATASET_QUERY_RATIO = 1.0
MULTIDATASET_DB_RATIO = 1.0
MULTIDATASET_TRAIN_RATIO = 0
